"""
ETER-ViT 학습 스크립트 v6_2
  - Config:     myConfig_choh_ETER_model_v6_2
...
from myConfig_choh_ETER_model_v6_2 import *
...
def main():
    print('====================================================')
    print(' [ETER-ViT v6_2] v6 best resume + gradient(edge) loss fine-tune')
    print('====================================================')
    ...
    if not check_env_for_model('eter', 'myConfig_choh_ETER_model_v6_2', strict=True):
        return
    ...
    wandb.init(
        ...
        name=f'ETER_v6_2_gradloss_BS{BATCH_SIZE}_LR{LEARNING_RATE_ADAM}_EP{NUM_EPOCHS}',
        config={
            'model': 'ETER-ViT-v6_2',

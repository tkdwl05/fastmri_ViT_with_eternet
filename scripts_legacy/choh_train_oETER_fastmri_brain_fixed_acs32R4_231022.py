...
# from myDataloader_fastmri_brain_230425 import choh_fastmri_brain_hybrid_ifft_acs32R4_train_v3
from myDataloader_fastmri_brain_fixed_220815 import choh_fastmri_brain_hybrid_ifft_fixed_acs32R4_toggle_train
from myDataloader_fastmri_brain_fixed_220815 import choh_fastmri_brain_hybrid_ifft_fixed_acs32R4_toggle_val
...
# from myConfig_ETER_fastmri_brain_acs32R4_retrain_4 import *
from myConfig_oETER_fastmri_brain_fixed_acs32R4 import *
...
def main():
	print('\n  choh, retrain o-ETER , fastmri brain_multi 16ch, fullsize 384x384, acs32R4, @main')
	...
	choh_data_valid = choh_fastmri_brain_hybrid_ifft_fixed_acs32R4_toggle_v2(idx_start= 310 , idx_end=311, flag_X_img_enable=True)
	...
	# eternet = ETER_hybrid_GRU_DFU().cuda()		### d-ETER
	# eternet = oETER_GRU_DFU().cuda()				### o-ETER

	eternet = oETER_GRU_DFU().cuda()
	# # eternet = torch.load(PATH_LEGACY+'tensors_entire.pt', map_location="cuda")
	# eternet = torch.load(PATH_LEGACY, map_location="cuda")
	# print(' pretrained weight loaded {}'.format(PATH_LEGACY))
	# eternet.train()

...
# PATH_SDB = '/mnt/sdb/choh/shared/W_python/myViT_jkps/'
...
def main(args):
	...
	if args.weight is not 0:
		...
		filename_trained_weight = 'tensors_cnt%d.pt'%filename_idx
		if args.weight < 0:
	...
	if flag_type=='testset':
		...
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_1_random(idx_start=320 , idx_end=320+59)
	...
	# 	choh_data_test = choh_fastmri_brain_hybrid_ifft_random_acs32R4_train(num_total_set=idx_patient)
		...
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_1_random(idx_start=idx_patient-1 , idx_end=idx_patient)
	elif flag_type=='p321':
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_1_random(idx_start=320 , idx_end=321)
	elif flag_type=='p55':
		print('\n\ntestset : p55_test')
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_1_random(idx_start=320+54 , idx_end=320+55)		### p55
	elif flag_type=='v41_train':
		print('\n\ntestset : v41_train')
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_1_random(idx_start=0 , idx_end=2)
	else:
...
if __name__ == '__main__':
	...
	parser.add_argument('-a','--amp', type=float, default='5', help='amplification for display of difference')
	parser.add_argument('-s','--set', type=str, default='p55', help='which set will be loaded')

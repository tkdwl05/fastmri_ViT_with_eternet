...
def main(args):
	...
	if flag_type=='testset':
		...
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_2(idx_start=320 , idx_end=320+59)
	...
	# 	choh_data_test = choh_fastmri_brain_hybrid_ifft_random_acs32R4_train(num_total_set=idx_patient)
		...
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_2(idx_start=idx_patient-1 , idx_end=idx_patient)
	elif flag_type=='p321':
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_2(idx_start=320 , idx_end=321)
	elif flag_type=='p55':
		print('\n\ntestset : p55_test')
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_2(idx_start=320+54 , idx_end=320+55)		### p55
	elif flag_type=='v41_train':
		print('\n\ntestset : v41_train')
		choh_data_test = choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_2(idx_start=0 , idx_end=2)
	else:

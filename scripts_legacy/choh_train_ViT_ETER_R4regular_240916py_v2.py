...
from myDataloader_fastmri_brain_R4_251012 import choh_fastmri_brain_hybrid_ifft_acs32R4_train_v4_2

from myConfig_choh_ViT_ETER_R4regular_v2 import *
...
def main():
	...
	for epoch in range(num_epochs):
		for n_set in range(NUM_TRAIN_SET):
			...
			choh_data_train = choh_fastmri_brain_hybrid_ifft_acs32R4_train_v4_2(idx_start= NUM_TRAIN_VOLUME_PER_SET*n_set , idx_end=NUM_TRAIN_VOLUME_PER_SET*n_set+NUM_TRAIN_VOLUME_PER_SET)
			...
			for i_batch, sample_batched in enumerate(trainloader):
				...
				print('Epoch [{}/{}], n_SET [{}/{}], n_counter {}, Step [{}/{}], loss: {:.6f}, pix: {:.6f}  1-ssim: {:.6f} '.format( 
					epoch+1, num_epochs, n_set+1, NUM_TRAIN_SET,  

...
class choh_fastmri_brain_hybrid_ifft_acs32R4_train_v4_1_random(Dataset):
	def __init__(self, idx_start = 0, idx_end = 300):
		########### val_amp modified 
		# 		val_amp_X_img = 1e5 -> 1e6
		# 		val_amp_X_ksp = 1e3 -> 1e4
		# 		val_amp_Y = 1e5 -> 1e6
		print('\n  @ myDataloader_fastmri_brain_random_250905.py ')
		print('\n  Dataset : choh_fastmri_brain_hybrid_ifft_acs32R4_train_v4_1_random')
		print('\n  choh_ifft2c_multi')

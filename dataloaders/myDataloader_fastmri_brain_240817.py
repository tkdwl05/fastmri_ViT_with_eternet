...
class choh_fastmri_brain_hybrid_ifft_acs32R4_train_v4_1(Dataset):
	def __init__(self, idx_start = 0, idx_end = 300):
		########### val_amp modified 
		# 		val_amp_X_img = 1e5 -> 1e6
		# 		val_amp_X_ksp = 1e3 -> 1e4
		# 		val_amp_Y = 1e5 -> 1e6
		print('\n  Dataset : choh_fastmri_brain_hybrid_ifft_acs32R4_train_v4_1')
		print('\n  choh_ifft2c_multi')
...
class choh_fastmri_brain_hybrid_ifft_acs32R4_train_v4(Dataset):
	def __init__(self, idx_start = 0, idx_end = 300):
		print('\n  Dataset : choh_fastmri_brain_hybrid_ifft_acs32R4_train_v4')
		print('\n  choh_ifft2c_multi')

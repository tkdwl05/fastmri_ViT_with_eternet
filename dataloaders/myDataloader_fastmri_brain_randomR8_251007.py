...
class choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_1_random(Dataset):
	def __init__(self, idx_start = 0, idx_end = 300):
		...
		print('\n  Dataset : choh_fastmri_brain_hybrid_ifft_acs16R8_train_v4_1_random')
		print('\n  choh_ifft2c_multi')
		...
		for filename in data_range:
			...
			idx_part1 = np.random.choice(192-8, 16, replace=False)				### 384/8=48 48-16=32 32/2=16(part1)
			idx_part2 = np.random.choice(192-8, 16, replace=False)+192+8		### 

...
class choh_fastmri_brain_hybrid_ifft_acs32R4_train(Dataset):
	def __init__(self, num_total_set = 300):
		print('\n  Dataset : choh_fastmri_brain_hybrid_ifft_acs32R4_train')
...
class choh_fastmri_brain_hybrid_ifft_acs32R4_val(Dataset):
	def __init__(self, num_total_set = 20):
		print('\n  Dataset : choh_fastmri_brain_hybrid_ifft_acs32R4_val')
...
class choh_fastmri_brain_hybrid_ifft_acs32R4_test59(Dataset):
	def __init__(self, num_total_set = 59):
		print('\n  Dataset : choh_fastmri_brain_hybrid_ifft_acs32R4_test59')

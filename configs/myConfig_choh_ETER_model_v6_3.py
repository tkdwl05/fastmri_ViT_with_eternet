"""ETER-ViT 설정 v6_3 — sharpness ablation (SS2D v6_3 와 동일 처방).

dropout 0.2 → 0.1, weight_decay 3e-5 → 1e-5.
v6 best 부터 50ep fine-tune, LR 5e-5 → 5e-7 cosine.
"""
import os

PATH_FOLDER = 'logs/ETER_ViT_R4_brain320_v6_3/'
...
LR_COSINE_MIN = 5e-7
LAMBDA_REGULAR_PER_PIXEL = 1e-5
LAMBDA_SSIM_PER_PIXEL = 1.0
LAMBDA_GRAD_PER_PIXEL = 0.0
